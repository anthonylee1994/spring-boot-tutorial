...
import com.learn.springboottutorial.service.photo.IPhotoService;
...
public class PhotoController {
    ...
    public ResponseEntity<ApiResponse> savePhoto(@RequestParam MultipartFile file, @RequestParam Long userId) {
        try {
